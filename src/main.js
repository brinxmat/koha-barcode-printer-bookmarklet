...
function getStylesheet () {
  return "        /* http://meyerweb.com/eric/tools/css/reset/ "
    ...
    + "        .spine { z-index: 1000; position: absolute; top: 95mm; left: 5px; font-size: 18px; width: 46mm; height: 30mm; overflow-wrap: normal; transform: rotate(180deg); transform-origin: 50% 50%; -webkit-transform: rotate(180deg); -webkit-transform-origin: 50% 50%; }";
}
...
function getLabelElement (doc, currentLabel, currentLabelId, key, value, barcode) {
  switch (key) {
    case "barcode":
